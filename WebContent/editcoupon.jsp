...
<div class="panel panel-primary coupouns_panel">
  <div class="panel-heading">
	...
	<form class="edit_form" role="form" action="/CouponsProject/adminController/updatecoupon" method="post" onsubmit="return editCouponValidateForm()">	
   <div class="form-group col-xs-3 user-list">
      <label for="coupon_name">Coupon Name</label>
         <input type="text" required class="form-control" name="c_name" 
            placeholder="<%=c_edit.getName() %>">
   </div>
   <div class="form-group col-xs-3 user-list">
      <label for="description">Description</label>
         <input type="text" required class="form-control" name="c_des"
            placeholder="<%=c_edit.getDescription() %>">
  	</div>
	  	<div class="form-group col-xs-3 user-list">
	      <label for="description">Category</label>
	         <input type="text" required class="form-control" name="c_cat" value="<%=c_edit.getCategory() %>"
	            ...
	            placeholder="Enter Coupon Longitude">
	  			...
	  			<div class="form-group col-xs-3 user-list">
		            ...
		            placeholder="Enter Coupon Latitude">
			          ...
			          <input type="text" required value="" class="form-control" name="exp_date" placeholder="Enter: yyyy-mm-dd hh:mm" />
